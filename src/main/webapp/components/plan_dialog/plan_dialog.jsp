...
<!DOCTYPE html>
<script src="${pageContext.request.contextPath}/components/plan_dialog/plan_dialog.js?<%= SelfX.VERSION %>" type="text/javascript" ></script>
<link href="${pageContext.request.contextPath}/components/plan_dialog/plan_dialog.css?<%= SelfX.VERSION %>" type="text/css" rel="stylesheet" />
