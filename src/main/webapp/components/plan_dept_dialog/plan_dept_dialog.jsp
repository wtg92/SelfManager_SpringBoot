...
<!DOCTYPE html>
<script src="${pageContext.request.contextPath}/components/plan_dept_dialog/plan_dept_dialog.js?<%= SelfX.VERSION %>" type="text/javascript" ></script>
<link href="${pageContext.request.contextPath}/components/plan_dept_dialog/plan_dept_dialog.css?<%= SelfX.VERSION %>" type="text/css" rel="stylesheet" />
