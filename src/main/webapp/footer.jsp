...
<script src="${pageContext.request.contextPath}/js/footer.js?<%= SelfX.VERSION %>" type="text/javascript" ></script>
<link href="${pageContext.request.contextPath}/css/footer.css?<%= SelfX.VERSION %>" type="text/css" rel="stylesheet" />
...
<div id="footer_main_container">
	...
	<div id="bei_an_mes_container" class="common_sub_main_container">
		<div class="bei_an_mes">
			<img src="<%=SelfX.BASIC_FILES_FOLDER%>beian.png"/>
