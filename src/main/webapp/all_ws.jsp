...
<script src="${pageContext.request.contextPath}/js/all_ws.js?<%= SelfX.VERSION %>" type="text/javascript" ></script>
<link href="${pageContext.request.contextPath}/css/all_ws.css?<%= SelfX.VERSION %>" type="text/css" rel="stylesheet" />
