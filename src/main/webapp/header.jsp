...
<script src="${pageContext.request.contextPath}/js/header.js?<%= SelfX.VERSION %>" type="text/javascript" ></script>
<link href="${pageContext.request.contextPath}/css/header.css?<%= SelfX.VERSION %>" type="text/css" rel="stylesheet" />
...
<div id="header_main_container"  class="common_dark_background common_light_font">
	<div id="header_sign_out_container" class="common_sub_main_container">
		<div id="left_flex_header_sign_out_container">
			<img class="web_logo" src="<%=SelfX.BASIC_FILES_FOLDER %>web_logo_white.png" title="返回首页"/>
		...
		<div id="right_flex_header_sign_out_container">
			<img src="<%=SelfX.BASIC_FILES_FOLDER %>web_spirit.png" class="spirit_img" title="精神"/>
		</div>
	</div>
