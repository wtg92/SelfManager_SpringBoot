	...
	Drag.prototype = {
		...
		buildHtml: function(content) {
			...
			var html = `<span class="drager top-left angle" data-direct="topLeft"></span>
						...
						<div class="head"><span class="title_for_drag_window">` + this.title + `</span><span class="delete_mark_for_drag_window">&times;</span></div>
		...
		setDrag: function() {
			var self = this;
			// 绑定点击关闭事件
			$(self.el).find('.delete_mark_for_drag_window').on('click', function(event) {
