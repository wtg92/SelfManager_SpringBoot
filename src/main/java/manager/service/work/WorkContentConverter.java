...
public abstract class WorkContentConverter {
    ...
    @Deprecated
    public static int addItemToWorkSheet(WorkSheet one, long adderId, int planItemId, int value, String note, int mood, boolean forAdd) throws LogicException {
    ...
    public static void removeItemFromWSPlan(WorkSheet one, long removerId, int itemId) throws LogicException {
        ...
        if (relevant != null) {
            throw new LogicException(SelfXErrors.CANNOT_DELETE_WS_PLAN_ITEM_WITH_WORK_ITEM);
        }
